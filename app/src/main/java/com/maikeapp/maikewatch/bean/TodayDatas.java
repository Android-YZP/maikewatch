...
public class TodayDatas {
    ...
    private float mile;
    private String date;
    private ArrayList<HourStemp> hourstemp;
    ...
    public ArrayList<HourStemp> getHourstemp() {
        return hourstemp;
    }

    public void setHourstemp(ArrayList<HourStemp> hourstemp) {
        this.hourstemp = hourstemp;
    }

    public class HourStemp{
        private int hour0;
        private int hour1;
        private int hour2;
        private int hour3;
